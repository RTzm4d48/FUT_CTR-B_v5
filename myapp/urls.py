...
urlpatterns = [
    ...
    path('download_pdf_procedure/', vws_createfut_process.download_pdf_procedure, name="n_download_pdf_procedure"),
    path('direct_download/', vws_createfut_process.direct_download, name="n_direct_download"),
